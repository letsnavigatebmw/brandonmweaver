          ...
          <div className="flex gap-16">
            <div>
              ...
              <ul className="space-y-2 text-gray-500 text-sm">
                ...
                <li>
                  <a href="#differentiator" className="hover:text-yellow-400 transition-colors">
                    How I Think
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-500 text-sm">
                ...
                <li>
                  <a href="mailto:brandon@navigatenow.com" className="hover:text-yellow-400 transition-colors">
                    Email
                  </a>
                </li>
              </ul>
