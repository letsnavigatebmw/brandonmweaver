      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          <a
            ...
            className="group p-8 border border-gray-800 rounded-lg hover:border-yellow-500 transition-all"
          >
            <Mail className="w-8 h-8 text-yellow-500 mb-4 group-hover:scale-110 transition-transform" />
          ...
          <a
            ...
            className="group p-8 border border-gray-800 rounded-lg hover:border-yellow-500 transition-all"
          >
            <Linkedin className="w-8 h-8 text-yellow-500 mb-4 group-hover:scale-110 transition-transform" />
        ...
        <div className="text-center">
          <a
            href="mailto:brandon@navigatenow.com"
            className="inline-block px-8 py-4 bg-yellow-500 text-black font-bold rounded-lg hover:bg-yellow-400 transition-all transform hover:scale-105 text-lg"
          >
            Send Email
          </a>
        </div>
